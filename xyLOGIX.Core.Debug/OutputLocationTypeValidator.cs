...
namespace xyLOGIX.Core.Debug
{
    ...
    /// the <see cref="T:xyLOGIX.Core.Debug.OutputLocationType" /> enumeration.
    /// </summary>
    internal class OutputLocationTypeValidator : IOutputLocationTypeValidator
    {
        ...
        /// implements the
        /// <see cref="T:xyLOGIX.Core.Debug.Interfaces.IOutputLocationTypeValidator" />
        /// interface.
        /// </summary>
        internal static IOutputLocationTypeValidator Instance { [DebuggerStepThrough] get; } =
            new OutputLocationTypeValidator();
        ...
        /// </returns>
        public bool IsValid(OutputLocationType type)
        {
            var result = false;
            ...
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine(
                    $"OutputLocationTypeValidator.IsValid: type = '{type}'"
                );
                 ...
                 * valid values defined by the xyLOGIX.Core.Debug.OutputLocationType enumeration. In
                ...
                System.Diagnostics.Debug.WriteLine(
                    $"OutputLocationTypeValidator.IsValid: Checking whether the value of the 'type' parameter, i.e., '{type}', is within the defined value set of its enumerated data type..."
                );
                ...
                if (!Enum.IsDefined(typeof(OutputLocationType), type))
                {
                    ...
                    System.Diagnostics.Debug.WriteLine(
                        $"OutputLocationTypeValidator.IsValid: Result = {result}"
                    );
                ...
                System.Diagnostics.Debug.WriteLine(
                    $"OutputLocationTypeValidator.IsValid: *** SUCCESS *** The value of the 'type' parameter, i.e., '{type}', is within the defined value set of its enumerated data type.  Proceeding..."
                );
                ...
                System.Diagnostics.Debug.WriteLine(
                    "OutputLocationTypeValidator.IsValid: *** SUCCESS *** The 'Unknown' value has NOT been specified for the 'type' parameter.  Proceeding..."
                );
