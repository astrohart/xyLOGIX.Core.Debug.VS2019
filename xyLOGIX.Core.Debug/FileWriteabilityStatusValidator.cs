...
namespace xyLOGIX.Core.Debug
{
    ...
    internal class FileWriteabilityStatusValidator : IFileWriteabilityStatusValidator
    {
        ...
        /// </returns>
        public bool IsValid(FileWriteabilityStatus status)
        {
            var result = false;
            ...
            try
            {
                 ...
                 * valid values defined by the xyLOGIX.Core.Debug.FileWriteabilityStatus
                 * enumeration. In principle, since all C# enums devolve to integer values, a hacker
                 * could insert a different value into the CPU register that the 'status' parameter
                ...
                if (!Enum.IsDefined(typeof(FileWriteabilityStatus), status))
                {
                    ...
                    System.Diagnostics.Debug.WriteLine(
                        $"FileWriteabilityStatusValidator.IsValid: Result = {result}"
                    );
                ...
                System.Diagnostics.Debug.WriteLine(
                    $"FileWriteabilityStatusValidator.IsValid: *** SUCCESS *** The value of the 'status' parameter, i.e., '{status}', is within the defined value set of its enumerated data type.  Proceeding..."
                );
