...
namespace xyLOGIX.Core.Debug
{
    ...
    /// specified <see cref="T:System.Type" /> and optional
    /// <see cref="T:System.String" /> that is set to the name of a log4net repository,
    /// if specified, per the
    /// <see cref="F:xyLOGIX.Core.Debug.SessionLoggerFetchApproach.FetchFromCache" />
    /// approach.
    /// </summary>
    [Log(AttributeExclude = true), ExplicitlySynchronized]
    internal class FetchFromCacheSessionLoggerFetcher : SessionLoggerFetcherBase
    {
        /// <summary>
        /// Initializes <see langword="static" /> data or performs actions that
        /// need to be performed once only for the
        /// <see cref="T:xyLOGIX.Core.Debug.FetchFromCacheSessionLoggerFetcher" /> class.
        /// </summary>
        /// <remarks>
        ...
        static FetchFromCacheSessionLoggerFetcher() { }

        /// <summary>
        /// Constructs a new instance of
        /// <see cref="T:xyLOGIX.Core.Debug.FetchFromCacheSessionLoggerFetcher" /> and
        ...
        /// via the
        /// <see cref="P:xyLOGIX.Core.Debug.FetchFromCacheSessionLoggerFetcher.Instance" />
        /// property.
        /// </remarks>
        [Log(AttributeExclude = true)]
        private FetchFromCacheSessionLoggerFetcher()
        { }
        ...
        public override SessionLoggerFetchApproach Approach { [DebuggerStepThrough] get; } =
            SessionLoggerFetchApproach.FetchFromCache;
        ...
        internal static ISessionLoggerFetcher Instance { [DebuggerStepThrough] get; } =
            new FetchFromCacheSessionLoggerFetcher();
