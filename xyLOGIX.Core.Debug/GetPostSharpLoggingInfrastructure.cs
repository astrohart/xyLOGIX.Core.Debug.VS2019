...
namespace xyLOGIX.Core.Debug
{
    ...
    internal static class GetPostSharpLoggingInfrastructure
    {
        ...
        /// the <see cref="T:xyLOGIX.Core.Debug.ILoggingInfrastructure" /> interface for
        /// the <see cref="F:xyLOGIX.Core.Debug.LoggingInfrastructureType.PostSharp" />
        /// logging infrastructure type value.
        /// </returns>
        [DebuggerStepThrough]
        [return: NotLogged]
