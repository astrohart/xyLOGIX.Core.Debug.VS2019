...
namespace xyLOGIX.Core.Debug
{
    ...
    /// is responsible for fetching loggers for client session(s).
    /// </summary>
    internal interface ISessionLoggerFetcher
    {
        /// <summary>
        /// Gets the <see cref="T:xyLOGIX.Core.Debug.SessionLoggerFetchApproach" />
        /// enumeration value that identifies the particular approach that is to be
        /// utilized to fetch a logger for a client session, or to use the legacy logger if
        /// no other approach is available.
        /// </summary>
        ...
        /// (Required.) Reference to an instance of <see cref="T:System.Type" /> that is
        /// utilized to identify the logger that is to be fetched for a client session.
        /// <para />
        /// Perhaps this value might come from an internal cache.
        /// </param>
        /// <param name="repositoryName">
        /// (Optional.) A <see cref="T:System.String" /> that is set to the name of the
        /// repository that is associated with the logger that is to be fetched for a
        /// client session.
        /// <para />
        ...
        /// <see cref="T:log4net.ILog" /> interface; otherwise, a <see langword="null" />
