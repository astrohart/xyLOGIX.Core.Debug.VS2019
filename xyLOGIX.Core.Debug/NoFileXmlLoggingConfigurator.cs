    ...
    internal class NoFileXmlLoggingConfigurator : XmlLoggingConfiguratorBase
    {
        ...
        )
        {
            ...
            try
            {
                ...
                // Check to see whether the configuration file is, indeed, non-existent. If this is
                ...
                // If the file specified by the configurationFileName does not actually exist, the
                // author of this software needs to know about it, so throw a FileNotFoundException
                ...
                // Check to see if the variable, 'loggers', has a null reference for a value. If it
                // does, then emit an error to the Debug output, and terminate the execution of this
                // method, returning the default return value.
                if (loggers == null)
                {
                    // The variable, 'loggers', has a null reference for a value.  This is not
                    // desirable.
                    System.Diagnostics.Debug.WriteLine(
                ...
                // Check to see whether the 'loggers' collection contains greater than zero
                // elements.  Otherwise, write an error message to the Debug output, return the
                // default return value, and then terminate the execution of this method.
                if (loggers.Count <= 0)
                {
