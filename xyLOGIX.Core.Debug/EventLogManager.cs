...
namespace xyLOGIX.Core.Debug
{
   ...
   public class EventLogManager
   {
      ...
      /// cref="Source"/> and <see cref="Type"/> properties. The content of the
      ...
      /// Name of the application that will be sending events.
      /// </param>
      /// <param name="type">
      /// One of the <see cref="T:xyLOGIX.Core.Debug.EventLogType"/> values that
