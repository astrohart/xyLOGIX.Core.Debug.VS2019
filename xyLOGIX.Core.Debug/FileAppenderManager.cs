...
namespace xyLOGIX.Core.Debug
{
   ...
   public static class FileAppenderManager
   {
      ...
      {
         // Check to see if the required parameter, name, is blank, whitespace,
         // or null. If it is any of these, throw an ArgumentNullException.
      ...
      /// cref="T:log4net.Appender.FileAppender"/>, or null if not found.
      /// </returns>
