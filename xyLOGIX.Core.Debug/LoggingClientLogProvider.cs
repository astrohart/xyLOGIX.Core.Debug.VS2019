    ...
    internal sealed class LoggingClientLogProvider : ILoggingClientLogProvider
    {
        ...
        )
        {
            ...
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine(
                    $"LoggingClientLogProvider.GetSessionLogger: *** FYI *** Getting a reference to an instance of the logger that corresponds to the source type, '{sourceType.FullName}' from the internal cache..."
                );
                ...
                // Check to see if the variable, 'logger', has a null reference for a value. If it
