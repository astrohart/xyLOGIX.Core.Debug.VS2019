...
namespace xyLOGIX.Core.Debug
{
    ...
    internal static class GetLoggingClientLoggerCacheAddHandlerTypeValidator
    {
        /// <summary>
        /// Initializes <see langword="static" /> data or performs actions that
        /// need to be performed once only for the
        /// <see cref="T:GetLoggingClientLoggerCacheAddHandlerTypeValidator" /> class.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        [Log(AttributeExclude = true)]
        static GetLoggingClientLoggerCacheAddHandlerTypeValidator() { }
