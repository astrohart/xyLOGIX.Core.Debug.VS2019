...
namespace xyLOGIX.Core.Debug
{
    ...
    /// the <see cref="T:xyLOGIX.Core.Debug.LoggingInfrastructureType" /> enumeration.
    /// </summary>
    internal class LoggingInfrastructureTypeValidator : ILoggingInfrastructureTypeValidator
    {
        /// <summary>
        ...
        public bool IsValid(LoggingInfrastructureType type)
        {
            ...
            try
            {
                ...
                /* For cybersecurity reasons, and to defeat reverse-engineering, check the value of
                 ...
                 valid values defined by the xyLOGIX.Core.Debug.LoggingInfrastructureType
