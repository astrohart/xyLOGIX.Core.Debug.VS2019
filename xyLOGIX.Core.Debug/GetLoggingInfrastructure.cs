...
namespace xyLOGIX.Core.Debug
{
    ...
    /// cref="T:xyLOGIX.Core.Debug.ILoggingInfrastructure"/> interface.
    /// </summary>
    public static class GetLoggingInfrastructure
    {
        /// <summary>
        /// Creates an instance of an object implementing the <see
        /// cref="T:xyLOGIX.Core.Debug.ILoggingInfrastructure"/> interface which
        /// corresponds to the value specified in <paramref name="type"/>, and
        ...
        /// implemented that correspond to the value of <paramref name="type"/>.
        /// </remarks>
        /// <exception cref="T:System.ArgumentOutOfRangeException">
        /// Thrown if there is no corresponding concrete type defined that
        /// implements the <see
        /// cref="T:xyLOGIX.Core.Debug.ILoggingInfrastructure"/> interface and
