...
namespace xyLOGIX.Core.Debug
{
    ...
    /// <c>XML Logging Configurator</c> object.
    /// </summary>
    /// <remarks>
    /// Such an object configures the logging subsystem by one means or
    /// another, depending on whether an XML configuration file is available or not.
    /// </remarks>
    public interface IXmlLoggingConfigurator
    {
        /// <summary>
        ...
        /// </summary>
        XmlLoggingConfiguratorType Type { [DebuggerStepThrough] get; }
