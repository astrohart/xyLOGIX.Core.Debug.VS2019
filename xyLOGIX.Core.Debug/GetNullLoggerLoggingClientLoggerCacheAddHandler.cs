...
namespace xyLOGIX.Core.Debug
{
    ...
    internal static class GetNullLoggerLoggingClientLoggerCacheAddHandler
    {
        /// <summary>
        /// Initializes <see langword="static" /> data or performs actions that
        /// need to be performed once only for the
        /// <see cref="T:GetNullLoggerLoggingClientLoggerCacheAddHandler" /> class.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        [Log(AttributeExclude = true)]
        static GetNullLoggerLoggingClientLoggerCacheAddHandler() { }
        ...
        internal static ILoggingClientLoggerCacheAddHandler SoleInstance()
        {
            ...
            try
            {
                result = NullLoggerLoggingClientLoggerCacheAddHandler.Instance;
            }
            catch (Exception ex)
            {
