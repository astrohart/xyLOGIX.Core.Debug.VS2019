...
namespace xyLOGIX.Core.Debug
{
    ...
    internal class EventLogTypeValidator : IEventLogTypeValidator
    {
        ...
        /// <param name="type">
        /// (Required.) One of the
        /// <see cref="T:xyLOGIX.Core.Debug.EventLogType" /> value(s) that is to be
        /// examined.
        /// </param>
        /// <returns>
        ...
        /// </returns>
        public bool IsValid(EventLogType type)
        {
            var result = false;
            ...
            try
            {
                ...
                if (!Enum.IsDefined(typeof(EventLogType), type))
                {
                    ...
                    System.Diagnostics.Debug.WriteLine(
                        $"EventLogTypeValidator.IsValid: Result = {result}"
                    );
                ...
                System.Diagnostics.Debug.WriteLine(
                    $"EventLogTypeValidator.IsValid: *** SUCCESS *** The value of the 'type' parameter, i.e., '{type}', is within the defined value set of its enumerated data type.  Proceeding..."
                );
