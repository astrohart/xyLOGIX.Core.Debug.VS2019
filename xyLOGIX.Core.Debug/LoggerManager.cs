...
namespace xyLOGIX.Core.Debug
{
    ...
    internal static class LoggerManager
    {
        ...
        /// once only for the <see cref="T:xyLOGIX.Core.Debug.LoggerManager" /> class.
        /// </summary>
        /// <remarks>
        ...
        /// </returns>
        internal static Logger GetRootLogger([NotLogged] ILoggerRepository loggerRepository = null)
        {
            Logger result = default;

            try
            {
                var strategy = Determine.TheRootLoggerProvisioningStrategyToUse(loggerRepository);
                ...
                // Check to see whether the Root Logger Provisioning Strategy is within the defined
                // value set. If this is not the case, then write an error message to the log file,
                // and then terminate the execution of this method.
                if (!RootLoggerProvisioningStrategyValidator.IsValid(strategy))
                {
                    // The Root Logger Provisioning Strategy is NOT within the defined value set.
                ...
                // We can use the variable, rootLoggerProvisioner, because it's not set to a null
                // reference.
                System.Diagnostics.Debug.WriteLine(
