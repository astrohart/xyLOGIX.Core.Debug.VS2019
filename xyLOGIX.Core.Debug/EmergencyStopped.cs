...
{
    /// <summary>
    /// Represents a handler for a <c>EmergencyStopPending</c> event.
    /// </summary>
    /// <param name="e">
    /// A <see cref="T:System.ComponentModel.CancelEventArgs" /> that contains the
    /// event data.
    /// <para />
    ...
    /// <c>EmergencyStopPending</c> event.
    /// </remarks>
