namespace xyLOGIX.Core.Debug
{
    ...
    public static class LogFileManager
    {
        ...
        ///     <see cref="T:xyLOGIX.Core.Debug.ILoggingInfrastructure" /> interface for
        ///     the
        ...
        ///     logging statements that are set to <see cref="DebugLevel.Debug" />.
        /// </param>
        ...
        ///     echo every message.
        /// </param>
        /// <param name="muteConsole">If set to <c>true</c>, suppresses all console output.</param>
        /// <param name="infrastructureType">
        ///     (Optional.) One of the
        ///     <see cref="T:xyLOGIX.Core.Debug.LoggingInfrastructureType" /> values that
        ///     indicates what type of logging infrastructure is to be utilized (default or
