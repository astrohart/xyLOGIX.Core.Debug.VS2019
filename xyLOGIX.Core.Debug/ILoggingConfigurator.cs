...
namespace xyLOGIX.Core.Debug
{
    ...
    /// <c>Logging Configurator</c> object that initializes logging based on whether
    /// said configuration is specifically spelled out in the <c>app.config</c> or
    /// <c>web.config</c> file, or if we are programmatically configuring logging.
    /// </summary>
