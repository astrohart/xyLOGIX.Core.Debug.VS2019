...
namespace xyLOGIX.Core.Debug
{
    ...
    internal static class GetFetchByRepositoryNameAndSourceTypeSessionLoggerFetcher
    {
        /// <summary>
        /// Initializes <see langword="static" /> data or performs actions that
        /// need to be performed once only for the
        /// <see cref="T:GetFetchByRepositoryNameAndSourceTypeSessionLoggerFetcher" />
        /// class.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        [Log(AttributeExclude = true)]
        static GetFetchByRepositoryNameAndSourceTypeSessionLoggerFetcher() { }
