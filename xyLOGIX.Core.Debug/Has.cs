...
{
    /// <summary>
    /// Exposes <see langword="static" /> methods to determine whether a
    /// console window is present.
    /// </summary>
    ...
    public static class Has
    {
        ...
        /// once only for the <see cref="T:xyLOGIX.Core.Debug.Has" /> class.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Gets or sets a value that is initialized with a
        /// <see cref="T:System.Boolean" /> that indicates whether the calling application
        /// is a Windows GUI app or a console app.
        /// </summary>
        /// <remarks>
        /// We use this property to avoid re-determining the nature of the current
        /// app if the <see cref="M:xyLOGIX.Core.Debug.Has.WindowsGui" /> method is called
        /// more than once.
        /// </remarks>
        ...
        /// <c>Windows Application</c> type in the <b>Project Properties</b> window in
        /// Visual Studio, but it never creates a window (at least, not using WPF or
        /// WinForms; this method cannot detect native Win32 P/Invoke calls to create a
        /// main window).
        /// </remarks>
        [DebuggerStepThrough]
        ...
        /// <summary>Determines whether logging has been configured.</summary>
        /// <returns>
        ...
        public static bool LoggingBeenSetUp()
        {
            ...
            try
            {
                ...
                // Check to see if the required property, 'LoggingServices.DefaultBackend', has a
                // null reference for a value. If that is the case, then we will write an error
                ...
                {
                    // The property, 'LoggingServices.DefaultBackend', has a null reference for a
                ...
                result = !(LoggingServices.DefaultBackend is NullLoggingBackend);
            }
            catch (Exception ex)
            {
            ...
            System.Diagnostics.Debug.WriteLine($"Has.LoggingBeenSetUp: Result = {result}");
