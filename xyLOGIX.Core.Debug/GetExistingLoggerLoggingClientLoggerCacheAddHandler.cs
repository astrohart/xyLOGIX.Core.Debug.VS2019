...
namespace xyLOGIX.Core.Debug
{
    ...
    internal static class GetExistingLoggerLoggingClientLoggerCacheAddHandler
    {
        /// <summary>
        /// Initializes <see langword="static" /> data or performs actions that need to be
        /// performed once only for the
        /// <see
        ///     cref="T:xyLOGIX.Core.Debug.GetExistingLoggerLoggingClientLoggerCacheAddHandler" />
        /// class.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        [Log(AttributeExclude = true)]
        static GetExistingLoggerLoggingClientLoggerCacheAddHandler() { }
        ...
        internal static ILoggingClientLoggerCacheAddHandler SoleInstance()
        {
            ...
            try
            {
                result = ExistingLoggerLoggingClientLoggerCacheAddHandler.Instance;
            }
            catch (Exception ex)
            {
