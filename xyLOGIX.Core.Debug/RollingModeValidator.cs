...
namespace xyLOGIX.Core.Debug
{
    ...
    public class RollingModeValidator : IRollingModeValidator
    {
        ...
        /// </summary>
        [Log(AttributeExclude = true)]
        protected RollingModeValidator() { }
        ...
        /// </summary>
        public static IRollingModeValidator Instance
        {
        ...
        /// </returns>
        public bool IsValid(RollingFileAppender.RollingMode mode)
        {
            var result = false;
            ...
            try
            {
                    ...
                    ))
                {
                    ...
                    System.Diagnostics.Debug.WriteLine(
                        $"RollingModeValidator.IsValid: Result = {result}"
                    );
