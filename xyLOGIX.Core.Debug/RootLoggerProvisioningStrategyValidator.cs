...
namespace xyLOGIX.Core.Debug
{
    ...
    /// the <see cref="T:xyLOGIX.Core.Debug.RootLoggerProvisioningStrategy" />
    /// enumeration.
    /// </summary>
    [Log(AttributeExclude = true)]
    internal class RootLoggerProvisioningStrategyValidator
        ...
        public bool IsValid(RootLoggerProvisioningStrategy strategy)
        {
            ...
            try
            {
                ...
                /* For cybersecurity reasons, and to defeat reverse-engineering, check the value of
                 the 'strategy' parameter to ensure that it is not set to a value outside the set of
                 valid values defined by the xyLOGIX.Core.Debug.RootLoggerProvisioningStrategy
                 enumeration. In principle, since all C# enums devolve to integer values, a hacker
                 could insert a different value into the CPU register that the 'strategy' parameter
                ...
                // Check whether the value of the 'strategy' parameter is within the defined value
                ...
                if (!Enum.IsDefined(typeof(RootLoggerProvisioningStrategy), strategy))
                {
                    // The value of the 'strategy' parameter is NOT within the defined value set for
                ...
                // Check whether the 'Unknown' value has been specified for the 'strategy'
                ...
                {
                    // The 'Unknown' value has been specified for the 'strategy' parameter.  This is
                    // not desirable.
                    System.Diagnostics.Debug.WriteLine(
