        ...
        : IRootLoggerProvisioningStrategyValidator
    {
        ...
        public bool IsValid(RootLoggerProvisioningStrategy strategy)
        {
            ...
            try
            {
                 ...
                 * the 'strategy' parameter to ensure that it is not set to a value outside the set
                 * of valid values defined by the xyLOGIX.Core.Debug.RootLoggerProvisioningStrategy
                 * enumeration. In principle, since all C# enums devolve to integer values, a hacker
                 * could insert a different value into the CPU register that the 'strategy'
