...
namespace xyLOGIX.Core.Debug
{
    ...
    public static class DebugUtils
    {
        ...
        /// <summary>
        /// Takes the reference to an instance of <see
        /// cref="T:System.Exception"/> that is passed in the <paramref
        /// name="e"/> parameter, formats it as a friendly error message along
        ...
        /// cref="T:xyLOGIX.Core.Debug.DebugLevel.Debug"/> , then this method
        ...
        /// cref="T:xyLOGIX.Core.Debug.DebugLevel"/> as its first argument, but
        /// if the formatted content consists of several lines of content, then
        /// the lines are split and logged separately, all under the <see
