...
namespace xyLOGIX.Core.Debug
{
   ...
   public static class DebugUtils
   {
      ...
      static DebugUtils()
      {
         // default ExceptionStackDepth is 1 for a Windows Forms app. Set to 2
         // for a Console App.
         ExceptionStackDepth = 1;
      }

      /// <summary>
      /// Occurs whenever text has been emitted by the <see
      /// cref="M:xyLOGIX.Core.Debug.DebugUtilsWrite"/> or <see
      /// cref="M:xyLOGIX.Core.Debug.DebugUtilsWriteLine"/> methods.
      /// </summary>
      ...
      /// <summary>
      /// Gets or sets a <see
      /// cref="T:xyLOGIX.Core.Debug.LoggingInfrastructureType"/> value
      ...
      /// iterates over the <paramref name="collection"/> and writes all of its
      ...
      /// reference to an instance of which is passed in the <paramref
      /// name="e"/> parameter, to be the error message on a line by itself,
      ...
      /// <summary>
      /// Writes the content in <paramref name="format"/> to the <paramref
      /// name="debugLevel"/> log.
      /// </summary>
      ...
      /// </param>
      /// <remarks>
      /// If the <paramref name="format"/> parameter is a blank or empty string,
      /// then this method does nothing. If the <c>DEBUG</c> constant is not
      ...
      /// property. If the property is set to true AND the <paramref
      /// name="debugLevel"/> parameter is set to <see
      /// cref="T:xyLOGIX.Core.Debug.DebugLevel.Debug"/>, then this method does
      ...
      /// <summary>
      /// Writes non-formatted content to the log using the <paramref
      /// name="debugLevel"/> specified. No line terminator is appended to the output.
      /// </summary>
      /// <param name="debugLevel">
      /// One of the <see cref="T:xyLOGIX.Core.Debug.DebugLevel"/> values that
      /// indicates which log (DEBUG, ERROR, INFO, WARN) where the content
      ...
      /// of <see cref="M:xyLOGIX.Core.Debug.DebugUtils.WriteCore"/>, except
      ...
      /// <summary>
      /// Works the same as the overload which takes a <see
      /// cref="T:xyLOGIX.Core.Debug.DebugLevel"/> as its first argument, but if
      /// the formatted content consists of several lines of content, then the
      /// lines are split and logged separately, all under the <see
      /// cref="T:xyLOGIX.Core.Debug.DebugLevel.Debug"/> debugLevel.
      /// </summary>
      /// <param name="format">
      /// (Required.) String containing an optional format specifier for
      /// parameters passed in <paramref name="args"/>.
      ...
      /// </param>
      /// <remarks>
      /// This overload specifies that the <see
      /// cref="T:xyLOGIX.Core.Debug.DebugLevel.Debug"/> logging debugLevel is
      ...
      /// <summary>
      /// Writes non-formatted content to the log using the <paramref
      /// name="debugLevel"/> specified, terminated by a newline character.
      /// </summary>
      /// <param name="debugLevel">
      /// One of the <see cref="T:xyLOGIX.Core.Debug.DebugLevel"/> values that
      /// indicates which log (DEBUG, ERROR, INFO, WARN) where the content
      ...
      /// then each line of content is logged separately, using the <paramref
      /// name="logMethod"/> supplied.
      /// </summary>
      /// <param name="content">
          ...
          DebugLevel level = DebugLevel.Debug)
      {
         ...
         // For each line, write it out at the debugLevel indicated, one by one.
         // We do this by calling the delegate supplied to this method in the
         // logMethod parameter.
