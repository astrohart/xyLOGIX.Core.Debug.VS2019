...
{
    /// <summary>
    /// Attempts to provision the root logger from an existing
    /// <c>Logger Repository</c> component that has been determined, in advance, to be
    /// convertible to a reference to an instance of
    /// <see cref="T:log4net.Repository.Hierarchy.Hierarchy" />.
    /// </summary>
    [Log(AttributeExclude = true)]
    internal class FromProvidedLoggingRepositoryRootLoggerProvisioner : RootLoggerProvisionerBase
    {
        /// <summary>
        ...
        /// </summary>
        [Log(AttributeExclude = true)]
        private FromProvidedLoggingRepositoryRootLoggerProvisioner()
        { }
        ...
        /// </summary>
        internal static IRootLoggerProvisioner Instance { [DebuggerStepThrough] get; } =
        ...
        /// </summary>
        public override RootLoggerProvisioningStrategy Strategy { [DebuggerStepThrough] get; } =
        ...
        /// <returns></returns>
        public override Logger Provision(ILoggerRepository loggerRepository = null)
        {
            ...
            try
            {
                ...
                // Check to see if the required parameter, loggerRepository, is null. If it is, send
                ...
                // Check to see whether the provided Logger Repository is convertible to
                // 'Hierarchy'. If this is not the case, then write an error message to the log
                // file, and then terminate the execution of this method.
                if (!(loggerRepository is Hierarchy hierarchyRepository))
                {
                    // The provided Logger Repository is NOT convertible to 'Hierarchy'.  This is
                    // not desirable.
                    System.Diagnostics.Debug.WriteLine(
                ...
                // Check to see if the variable, hierarchyRepository, is null.  If it is, send an
                // error to the log file, and then terminate the execution of this method, returning
                // the default return value.
                if (hierarchyRepository == null)
                {
                    // the variable hierarchyRepository is required to have a valid object
                    // reference.
                    System.Diagnostics.Debug.WriteLine(
                ...
                // We can use the variable, hierarchyRepository, because it's not set to a null
                // reference.
                System.Diagnostics.Debug.WriteLine(
