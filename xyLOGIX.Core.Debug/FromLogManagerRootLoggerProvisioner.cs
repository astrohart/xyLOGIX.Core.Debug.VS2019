...
{
    /// <summary>
    /// This concrete class simply executes the fallback provisioning strategy
    /// and attempts to return the value of such, ignoring any provided reference to a
    ...
    internal class FromLogManagerRootLoggerProvisioner : RootLoggerProvisionerBase
    {
        ...
        /// implements the <see cref="T:xyLOGIX.Core.Debug.IRootLoggerProvisioner" />
        /// interface for the
