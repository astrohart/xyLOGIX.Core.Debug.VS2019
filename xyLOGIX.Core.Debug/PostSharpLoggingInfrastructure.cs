...
namespace xyLOGIX.Core.Debug
{
   ...
   public class PostSharpLoggingInfrastructure : DefaultLoggingInfrastructure
   {
      ...
      /// by switching out the <see cref="T:log4net.Repository.ILoggerRepository"/>
          ...
          ILoggerRepository repository = null)
      {
         ...
         // methods, and all logger repositories created from now on will come
         // from this repository selector.
         //
         ...
         // Use the relay repository to create a Log4NetLoggingBackend and set
         // it as the default backend:
