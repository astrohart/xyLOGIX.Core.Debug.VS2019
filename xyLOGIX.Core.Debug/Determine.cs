...
namespace xyLOGIX.Core.Debug
{
    ...
    internal static class Determine
    {
        ...
        private static ILoggingClientLoggerCacheAddOutcomeValidator
            LoggingClientLoggerCacheAddOutcomeValidator { [DebuggerStepThrough] get; } =
        ...
        /// operation-success state, attempts to determine the corresponding
        /// logging-client logger-cache <c>Add</c> outcome.
        /// </summary>
        /// <param name="handlerType">
        /// (Required.) One of the
        /// <see cref="T:xyLOGIX.Core.Debug.LoggingClientLoggerCacheAddHandlerType" />
        /// value(s) that identifies the handler strategy whose corresponding outcome is
        /// to be determined.
        /// </param>
        /// <param name="addOperationSucceeded">
        /// (Required.) A <see cref="T:System.Boolean" /> value indicating whether the
        /// logging-client logger-cache <c>Add</c> operation succeeded.
        /// </param>
        /// <remarks>
        /// The
        /// <see
        ...
        )
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine(
                    $"Determine.TryMapLoggingClientLoggerCacheAddOutcome: *** FYI *** Getting the expected logging-client logger cache 'Add' outcome for the specified handler type, '{handlerType}', with addOperationSucceeded = {addOperationSucceeded}..."
                );

                System.Diagnostics.Debug.WriteLine(
                    $"Determine.TryMapLoggingClientLoggerCacheAddOutcome: Checking whether the specified logging-client logger cache 'Add' operation handler type, '{handlerType}', is within the defined value set..."
                );
                ...
                if (!LoggingClientLoggerCacheAddHandlerTypeValidator.IsValid(handlerType))
                {
                    // The specified logging-client logger cache Add operation handler type is
                    // not within the defined value set. This is not desirable.
                    System.Diagnostics.Debug.WriteLine(
                        $"Determine.TryMapLoggingClientLoggerCacheAddOutcome: *** ERROR *** The specified logging-client logger cache 'Add' operation handler type, '{handlerType}', is NOT within the defined value set.  Stopping..."
                    );

                    System.Diagnostics.Debug.WriteLine(
                        $"Determine.TryMapLoggingClientLoggerCacheAddOutcome: Result = '{result}'"
                    );
                ...
                System.Diagnostics.Debug.WriteLine(
                    $"Determine.TryMapLoggingClientLoggerCacheAddOutcome: *** SUCCESS *** The specified logging-client logger cache 'Add' operation handler type, '{handlerType}', is within the defined value set.  Proceeding..."
                );
        ...
        /// given the current state of the logging-client logger cache.
        /// </summary>
        /// <param name="handlerType">
        /// (Required.) One of the
        /// <see cref="T:xyLOGIX.Core.Debug.LoggingClientLoggerCacheAddHandlerType" />
        ...
        )
        {
            ...
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine(
                    "Determine.WhetherAddHandlerTypeAndOutcomeComboIsValid: Checking whether the property, 'LoggingClientLoggerCacheAddOutcomeValidator', has a null reference for a value..."
                );

                // Check whether the required outcome validator is available. If this is not
                // the case, then write an error message to the Debug output and terminate the
                // execution of this method.
                if (LoggingClientLoggerCacheAddOutcomeValidator == null)
                {
                    ...
                    System.Diagnostics.Debug.WriteLine(
                        "Determine.WhetherAddHandlerTypeAndOutcomeComboIsValid: *** ERROR *** The property, 'LoggingClientLoggerCacheAddOutcomeValidator', has a null reference for a value.  Stopping..."
                    );
                ...
                System.Diagnostics.Debug.WriteLine(
                    "Determine.WhetherAddHandlerTypeAndOutcomeComboIsValid: *** SUCCESS *** The property, 'LoggingClientLoggerCacheAddOutcomeValidator', has a valid object reference for its value.  Proceeding..."
                );

                System.Diagnostics.Debug.WriteLine(
                    $"Determine.WhetherAddHandlerTypeAndOutcomeComboIsValid: Checking whether the specified logging-client logger cache 'Add' outcome, '{outcome}', is within the defined value set..."
                );

                // Check whether the specified outcome is within the defined value set. If this
                ...
                if (!LoggingClientLoggerCacheAddOutcomeValidator.IsValid(outcome))
                {
                    ...
                    // desirable.
                    System.Diagnostics.Debug.WriteLine(
                        $"Determine.WhetherAddHandlerTypeAndOutcomeComboIsValid: *** ERROR *** The specified logging-client logger cache 'Add' outcome, '{outcome}', is NOT within the defined value set.  Stopping..."
                    );
                ...
                System.Diagnostics.Debug.WriteLine(
                    $"Determine.WhetherAddHandlerTypeAndOutcomeComboIsValid: *** SUCCESS *** The specified logging-client logger cache 'Add' outcome, '{outcome}', is within the defined value set.  Proceeding..."
                );
                ...
                System.Diagnostics.Debug.WriteLine(
                    $"Determine.WhetherAddHandlerTypeAndOutcomeComboIsValid: Checking whether the expected logging-client logger cache 'Add' outcome, '{expectedOutcome}', is within the defined value set..."
                );

                // Check whether the expected outcome is within the defined value set. If this
                // is not the case, then write an error message to the Debug output and
                // terminate the execution of this method.
                if (!LoggingClientLoggerCacheAddOutcomeValidator.IsValid(expectedOutcome))
                {
                    ...
                    // desirable.
                    System.Diagnostics.Debug.WriteLine(
                        $"Determine.WhetherAddHandlerTypeAndOutcomeComboIsValid: *** ERROR *** The expected logging-client logger cache 'Add' outcome, '{expectedOutcome}', is NOT within the defined value set.  Stopping..."
                    );
                ...
                System.Diagnostics.Debug.WriteLine(
                    $"Determine.WhetherAddHandlerTypeAndOutcomeComboIsValid: *** SUCCESS *** The expected logging-client logger cache 'Add' outcome, '{expectedOutcome}', is within the defined value set.  Proceeding..."
                );

                System.Diagnostics.Debug.WriteLine(
                    $"Determine.WhetherAddHandlerTypeAndOutcomeComboIsValid: Checking whether the specified outcome, '{outcome}', matches the expected outcome, '{expectedOutcome}'..."
                );

                // Check whether the specified outcome matches the expected outcome. If this
                // is not the case, then write an error message to the Debug output and
                // terminate the execution of this method.
                if (!expectedOutcome.Equals(outcome))
                {
                    ...
                    // desirable.
                    System.Diagnostics.Debug.WriteLine(
                        $"Determine.WhetherAddHandlerTypeAndOutcomeComboIsValid: *** ERROR *** The specified outcome, '{outcome}', does not match the expected outcome, '{expectedOutcome}', for the handler type, '{handlerType}'.  Stopping..."
                    );
                ...
                System.Diagnostics.Debug.WriteLine(
                    $"Determine.WhetherAddHandlerTypeAndOutcomeComboIsValid: *** SUCCESS *** The handler type, '{handlerType}', and outcome, '{outcome}', form a valid combination.  Proceeding..."
                );
