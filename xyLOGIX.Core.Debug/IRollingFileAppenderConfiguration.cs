...
namespace xyLOGIX.Core.Debug
{
    ...
    /// object that encapsulates the configuration for a
    ...
    public interface IRollingFileAppenderConfiguration
    {
        ...
        /// </remarks>
        bool AppendToFile { [DebuggerStepThrough] get; [DebuggerStepThrough] set; }

        /// <summary>Gets or sets the path to the file that logging will be written to.</summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="T:log4net.Layout.ILayout" /> for this
        /// appender.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to always log to the same
        /// file.
        /// </summary>
        /// <value>
        /// <see langword="true" /> if always should be logged to the same file,
        ...
        ///     </para>
        /// </remarks>
        bool StaticLogFileName { [DebuggerStepThrough] get; [DebuggerStepThrough] set; }
    }
}